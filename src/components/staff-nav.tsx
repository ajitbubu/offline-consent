...
import { BellRing, FileText, Inbox, LayoutDashboard, LogOut, OctagonX, Tablet, Upload, Users } from "lucide-react";
...
const LINKS = [
  ...
  { href: "/staff/kiosk", label: "Counter kiosk", icon: Tablet, minimum: "operator" },
